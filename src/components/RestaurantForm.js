...
const RestaurantForm = ({}) => {
    ...
    const [heur_open,setHeurOpen]=useState(0);
    const [heur_close,setHeurClose]=useState(0);
        ...
        <div className="container mt-3  p-5">
            <Card className="shadow-lg">
                <CardHeader className="d-flex bg-success   justify-content-between flex-row">
                    <CardTitle className="text-white">Add Resaturant</CardTitle>
                </CardHeader>
                ...
                <CardBody>
                    <form onSubmit={handleSubmit}>
                        <div className="row">
                            ...
                            <div className="col-lg-6 col-md-6 col-sm-12 p-3">
                                <label htmlFor="heur_open" className="form-label">Heur Open:</label>
                                <input type="number" step="any" className="form-control" id="heuropen" value={heur_open}
                                       onChange={(event) => setHeurOpen(parseFloat(event.target.value))}/>
                            </div>
                            <div className="col-lg-6 col-md-6 col-sm-12 p-3">
                                <label htmlFor="heur_close" className="form-label">Heur Close:</label>
                                <input type="number" step="any" className="form-control" id="heurclose" value={heur_close}
                                       onChange={(event) => setHeurClose(parseFloat(event.target.value))}/>
                            </div>
